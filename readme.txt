Process pour Pusher (Via VSCode) : 

1. Modifier le fichier
2. Dans le menu "Source Control", cliquer sur le bouton "+" au niveau du fichier modifié
...
3. Et cliquer sur 'Trigger deploy' puis 'Deploy site'
4. Enfin, vérifier que le déploiement s'est bien passé avec l'état 'Published'
